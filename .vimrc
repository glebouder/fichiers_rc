...
set shiftwidth=2 " indente à 4 colonnes pour les opération de réindentations
set softtabstop=4
set expandtab
...
"set ignorecase		" Do case insensitive matching (also named ic)
set smartcase		" Do smart case matching,(sensitif ssi motif contient une majuscule)
set incsearch		" Incremental search (also named is)
